...
import com.solr.clientwrapper.rest.errors.EmailAlreadyUsedException;
import com.solr.clientwrapper.config.Constants;
import com.solr.clientwrapper.domain.dto.AdminUserDTO;
import com.solr.clientwrapper.infrastructure.entity.User;
import com.solr.clientwrapper.rest.errors.LoginAlreadyUsedException;
import com.solr.clientwrapper.security.AuthoritiesConstants;
...
public class UserResource {
	 ...
	 * 
	 * public UserResource(UserServicePort userServicePort) { this.userServicePort =
	 * userServicePort;
	 * 
	 * }
	 */
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody AdminUserDTO userDTO) throws URISyntaxException {
        ...
        User newUser = createUser.createUser(userDTO);
    ...
    public ResponseEntity<AdminUserDTO> updateUser(@Valid @RequestBody AdminUserDTO userDTO) {
        ...
        Optional<AdminUserDTO> updatedUser = updateUser.updateAdminUser(userDTO);
    ...
    public ResponseEntity<List<AdminUserDTO>> getAllUsers(Pageable pageable) {
        ...
        final Page<AdminUserDTO> page =  readUser.getAllManagedUsers(pageable);
    ...
    public ResponseEntity<AdminUserDTO> getUser(@PathVariable @Pattern(regexp = Constants.LOGIN_REGEX) String login) {
        ...
        return ResponseUtil.wrapOrNotFound(readUser.getUserWithAuthoritiesByLogin(login).map(AdminUserDTO::new));
    }
