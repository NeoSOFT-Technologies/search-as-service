...
public class UserResource {
    ...
    public ResponseEntity<ResponseDTO> getToken(@RequestBody UserDTO userDTO) {
        ResponseDTO responseDTO = userServicePort.getToken(userDTO.getUserName(), userDTO.getPassword());
