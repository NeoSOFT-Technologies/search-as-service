...
public class KeycloakAdminClientUtils {
    ...
    private KeycloakAdminClientUtils() {}
    ...
    public static Keycloak getKeycloakClientRestEasy(KeycloakAdminClientConfig config) {
     ...
     */
    public static void addRoleToListOf(
    		Keycloak keycloak, KeycloakAdminClientConfig keycloakAdminClientConfig, 
        ...
        final boolean compositeExists = existingRoles.stream().anyMatch(r -> r.getName().equals(compositeRole) && !compositeRole.isEmpty());
     ...
     */
    public static void removeRoleInListOf(
    		Keycloak keycloak, KeycloakAdminClientConfig keycloakAdminClientConfig, 
     ...
     * @return
     */
    public static List<RoleRepresentation> removeRoleInList(
    		List<RoleRepresentation> listOfRoleRepresentation, RoleRepresentation roleToBeRemove) {
