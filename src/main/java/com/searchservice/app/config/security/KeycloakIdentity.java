...
public class KeycloakIdentity {
    ...
    public KeycloakIdentity(KeycloakSecurityContext securityContext) {
...
//		
//    	KeycloakIdentity keycloakIdentity = new KeycloakIdentity(new KeycloakSecurityContext());
//    	
//    	String prefUsername = keycloakIdentity.getName();
//    	
