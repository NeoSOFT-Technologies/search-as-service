package com.solr.clientwrapper.documentParser;
...
@WithMockUser
public class SolrDocumentParserUtilTest {
    ...
    void incorrectBooleanInputJSONObject() throws Exception {
        ...
        String inputString="{\n" +
                "\"id\":1," +
                "\"custom_field_boolean\":\"not-a-bool\"," +
                "\"custom_field_booleans\":[1,0,\"1\"]," +
                "\"custom_field_plong\":60," +
                "\"custom_field_plongs\":[22,56,59]," +
                "\"custom_field_string\":karthik," +
    ...
    void incorrectBooleanArrayInputJSONObject() throws Exception {
        ...
        String inputString="{\n" +
                "\"id\":1," +
                "\"custom_field_boolean\":\"true\"," +
                "\"custom_field_booleans\":[\"incorrect-bool\",\"false\",\"1\"]," +
                "\"custom_field_plong\":60," +
                "\"custom_field_plongs\":[22,56,59]," +
                "\"custom_field_string\":karthik," +
                "\"custom_field_strings\":[\"kar\",\"mani\",\"sara\"]," +
    ...
    void invalidNewFieldInInputJSONObject() throws Exception {
        ...
        String inputString="{\n" +
                ...
                "\"custom_field_string\":karthik," +
                "\"custom_field_strings\":\"karthik\"," +
                "\"invalid_new_field\":\"random_value\"," +
                "\"custom_required_field_boolean\":\"true\"," +
                "}";
        JSONObject payloadJSON  = new JSONObject(inputString);
