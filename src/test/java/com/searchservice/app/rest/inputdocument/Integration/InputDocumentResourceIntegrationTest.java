...
public class InputDocumentResourceIntegrationTest {
	...
	static private String baseTokenUrl = "http://localhost:8083/user/token";
	...
	void setUpBeforeTest() {
		...
		int createTableStatusCode = createTable(tableName);
		if(createTableStatusCode != 200) System.out.println("Error while creating table for Test cases - Statsus Code" + createTableStatusCode);	
	}
	...
	void createAttributesList() {
		SchemaField category = new SchemaField("category", "strings", false, true, true, true, false, false);
		SchemaField id = new SchemaField("id", "string", true, true, true, false, false, false);
		SchemaField isAvailable = new SchemaField("isAvailable", "boolean", false, true, true, false, true, false);
		SchemaField name = new SchemaField("name", "string", false, false, false, false, false, false);
		SchemaField price = new SchemaField("price", "long", true, true, true, false, true, false);
		SchemaField productName = new SchemaField("productName", "string", false, true, true, false, false, true);
		SchemaField title = new SchemaField("title", "string", false, true, true, false, false, true);
		SchemaField vendorId = new SchemaField("vendorId", "longs", false, true, true, true, false, false);
		attributes = new ArrayList<>(Arrays.asList(category,id,isAvailable,name,price,productName,title,vendorId));
	...
	{	
		assertEquals(105, addDocumentsNRTWithInvalidJSONInput());
	...
	{	
		assertEquals(406, addDocumentsNRTRequestSizeLimiting());
	...
	{	
		assertEquals(108, addDocumentsNRTTableNotFound());
	...
	{	
		assertEquals(105, addDocumentsBatchInvalidJsonInput());
	...
	{	
		assertEquals(108, addDocumentsBatchTableNotFound());
